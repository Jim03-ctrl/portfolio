  ...
  const projects = [
    {
      ...
      description: "Payroll Management System is a web application that automates the payroll process, ensuring accurate and timely salary calculations.",
    ...
    },
    {
      ...
      description: "VRLENS is an e-commerce platform that offers a wide range of virtual reality products, providing an immersive shopping experience.",
      image: "/images/VRLENS.png",
      link: "#",
    },  
  ];
